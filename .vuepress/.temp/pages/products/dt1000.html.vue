<template><h1 id="dt1000" tabindex="-1"><a class="header-anchor" href="#dt1000" aria-hidden="true">#</a> DT1000</h1>
<p>Complete wireless connectivity solution build on GIGC's first generation of 2.4GHz FHSS radio transceiver.</p>
<h2 id="specifications-and-options" tabindex="-1"><a class="header-anchor" href="#specifications-and-options" aria-hidden="true">#</a> Specifications and Options</h2>
<ul>
<li>Line of sight range up to 1.6km with antenna.</li>
<li>Data rate up to 9.6/19.2kbps.</li>
<li>Meets IP65 protection requirements</li>
</ul>
<table width="100%">
<tbody>
<tr>
